...
public class MapRelative {
    ...
    String poetList(@RequestBody String sql){
        return MySqlOP.select(sql, "name","id").toString();
    }
    ...
    String poetriesList(@RequestBody String sql){
        return MySqlOP.select(sql,"name","dynasty","age","city_of_ancient","city_of_current","county_of_ancient","county_of_current","id",
